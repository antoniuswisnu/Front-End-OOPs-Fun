...
function QuestionQuiz() {
  ...
  useEffect(() => {
    ...
    const getQuestions = async () => {
      let result = await fetch("http://localhost:8080/teacher/class/quiz/question", {
        method: "post",
  ...
  const deleteQuestion = async (index) => {
    let deleteQues = await fetch(`http://localhost:8080/teacher/class/quiz/question/delete`, {
      method: "post",
  ...
  return (
    <div className="container">
      ...
      <h1 className="judul mb-3">Daftar Soal</h1>
        ...
        <div key={index} className="card mb-2">
          <div className="card-body">
            ...
            <div className="kanan mt-2">
              <button type="button" className="btn btn-danger" onClick={() => deleteQuestion(index, question._id)}>
                Hapus
              </button>
            </div>
          </div>
